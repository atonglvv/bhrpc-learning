...
public class ConsumerDemoServiceImpl implements ConsumerDemoService {
    ...
    @RpcReference(registryType = "zookeeper", registryAddress = "192.168.184.102:2181", loadBalanceType = "zkconsistenthash", version = "1.0.0", group = "binghe", serializationType = "protostuff", proxy = "cglib", timeout = 30000, async = false, oneway = false)
