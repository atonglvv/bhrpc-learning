...
public class RpcConsumerNativeTest {
    ...
    public static void main(String[] args){
        RpcClient rpcClient = new RpcClient("127.0.0.1:2181", "zookeeper", "random", "jdk", "1.0.0", "binghe", "hessian2", 3000, false, false);
    ...
    public void initRpcClient(){
        rpcClient = new RpcClient("127.0.0.1:2181", "zookeeper", "enhanced_zkconsistenthash","asm","1.0.0", "binghe", "protostuff", 3000, false, false);
    }
