...
public class RpcConsumerNativeTest {
    ...
    public static void main(String[] args){
        RpcClient rpcClient = new RpcClient("127.0.0.1:2181", "zookeeper", "random", "jdk", "1.0.0", "binghe", "hessian2", 3000, false, false, 30000, 60000, 1000, 3, true, 10000, true, "127.0.0.1:27880", true);
    ...
    public void initRpcClient(){
        rpcClient = new RpcClient("127.0.0.1:2181", "zookeeper", "enhanced_leastconnections","asm","1.0.0", "binghe", "protostuff", 3000, false, false, 30000, 60000, 1000, 3, true, 10000, true, "127.0.0.1:27880", true);
    }
